...
- **Exemples en situation** : les mots du carnet peuvent porter des phrases d'exemple (hébreu avec nikud, translittération, français). Sur la carte, un discret « Voir un exemple » les déplie une fois la réponse visible — jamais avant, il révélerait la réponse — avec un bouton Écouter par phrase ; la recherche les montre aussi dans son tiroir. Premier lot : les mots faciles du quotidien, le reste s'écrit progressivement.
